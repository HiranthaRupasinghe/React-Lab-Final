  ...
  return (
    <div className="card">
      ...
      <div className="row">
        ...
        onClick={()=>dispatch({type:"setStatus",status:"loading"})}>Loading</button>
        {/**/}
        <button className="btn"
        onClick={()=>dispatch({type:"setStatus",status:"success"})}>Success</button>
        {/**/}
        <button className="btn"
        onClick={()=>dispatch({type:"setStatus",status:"error"})}>Error</button>
      </div>
